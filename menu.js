...
card1.addEventListener("click", function() {
  ...
  if (card1.firstElementChild.src == "http://127.0.0.1:5500/img/01.jpg") {
    card1.firstElementChild.src = "http://127.0.0.1:5500/img/arrow-right.svg";
    card1.classList.add("reset-transform");
    card2.classList.add("reset-transform");
    card3.classList.add("reset-transform");
  } else {
    card1.firstElementChild.src = "http://127.0.0.1:5500/img/01.jpg";
...
card11.addEventListener("click", function() {
  ...
  if (card11.firstElementChild.src == "http://127.0.0.1:5500/img/01.jpg") {
    card11.firstElementChild.src = "http://127.0.0.1:5500/img/arrow-right.svg";
    ...
    card11.firstElementChild.src = "http://127.0.0.1:5500/img/01.jpg";
